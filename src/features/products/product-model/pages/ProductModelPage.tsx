...
const brands = [
  { brandId: "Samsung", id: "type-mobile", name: "Mobile" },
  { brandId: "LG", id: "type-tv", name: "TV" },
];
const productTypes = [
...
export function ProductModelPage() {
  ...
  const fields = useMemo(
    () => createProductModelFormConfig({ productTypes, brands }),
    [],
  );
  const createProductModel = async (values: Record<string, unknown>) => {
    ...
    const model: ProductModel = {
      ...
      productTypeId,
      productTypeName: productTypes.find((type) => type.id === productTypeId)
        ?.name,
    ...
    notifications.success(
      ...
      `${model.name} was created successfully.`,
    );
  };
  return (
    <ProductCrudLayout
      ...
      addButtonLabel="Add Product Model"
      form={

...
export interface TextFieldConfig extends BaseFieldConfig {
  type: "text"; placeholder?: string; minLength?: number; maxLength?: number; pattern?: string; autoComplete?: string;
}
...
export interface PasswordFieldConfig extends BaseFieldConfig {
  type: "password"; placeholder?: string; minLength?: number; maxLength?: number;
}
...
export interface TelFieldConfig extends BaseFieldConfig {
  type: "tel"; placeholder?: string; pattern?: string;
}
export interface UrlFieldConfig extends BaseFieldConfig {
  type: "url"; placeholder?: string;
}
export interface TextareaFieldConfig extends BaseFieldConfig {
  type: "textarea"; placeholder?: string; rows?: number; minLength?: number; maxLength?: number;
}
export interface SelectFieldConfig extends BaseFieldConfig {
  type: "select"; placeholder?: string; options: SelectOption[];
}
export interface MultiSelectFieldConfig extends BaseFieldConfig {
  type: "multiSelect"; placeholder?: string; options: SelectOption[]; maxSelections?: number;
}
export interface RadioFieldConfig extends BaseFieldConfig {
  type: "radio"; options: SelectOption[]; orientation?: "horizontal" | "vertical";
}
...
export interface MonthFieldConfig extends BaseFieldConfig {
  type: "month"; min?: string; max?: string;
}
export interface WeekFieldConfig extends BaseFieldConfig {
  type: "week"; min?: string; max?: string;
}
...
export interface FileFieldConfig extends BaseFieldConfig {
  type: "file"; accept?: string; multiple?: boolean; maxFiles?: number; maxSizeBytes?: number;
}
...
export type FormFieldConfig =
  | TextFieldConfig | EmailFieldConfig | PasswordFieldConfig | NumberFieldConfig
  | TelFieldConfig | UrlFieldConfig | TextareaFieldConfig | SelectFieldConfig
  | MultiSelectFieldConfig | RadioFieldConfig | CheckboxFieldConfig | ToggleFieldConfig
  | DateFieldConfig | TimeFieldConfig | DateTimeFieldConfig | MonthFieldConfig
  | WeekFieldConfig | ColorFieldConfig | RangeFieldConfig | FileFieldConfig
  | HiddenFieldConfig;
